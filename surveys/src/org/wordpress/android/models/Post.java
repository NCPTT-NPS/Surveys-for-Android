...
public class Post {
    ...
    public Post(int blog_id, long post_id, boolean isPage) {
        ...
        if (postVals != null) {
            ...
            this.rbca_coord_latitude = Double.parseDouble(postVals.get(33).toString());
            this.rbca_coord_longitude = Double.parseDouble(postVals.get(34).toString());
            this.rbca_coord_altitude = Double.parseDouble(postVals.get(35).toString());
            this.rbca_coord_accuracy = Double.parseDouble(postVals.get(36).toString());
            ...
            this.rbca_bldg_occucy_avail = Integer.parseInt(postVals.get(54).toString());
            this.rbca_bldg_stories = Double.parseDouble(postVals.get(55).toString());
            this.rbca_bldg_width = Double.parseDouble(postVals.get(56).toString());
            this.rbca_bldg_length = Double.parseDouble(postVals.get(57).toString());
            this.rbca_bldg_use = postVals.get(58).toString();
            this.rbca_bldg_use_oth = postVals.get(59).toString();
            this.rbca_bldg_outbldg = Integer.parseInt(postVals.get(60).toString());
            this.rbca_bldg_outbldg_notes = postVals.get(61).toString();
            this.rbca_bldg_units_res = Integer.parseInt(postVals.get(62).toString());
            this.rbca_bldg_units_comm = Integer.parseInt(postVals.get(63).toString());
            this.rbca_bldg_occu_name = postVals.get(64).toString();
            this.rbca_bldg_occu_phone = Integer.parseInt(postVals.get(65).toString());;
            ...
            this.rbca_hist_appear = Integer.parseInt(postVals.get(71).toString());
            this.rbca_hist_age = Integer.parseInt(postVals.get(72).toString());  
            this.rbca_hist_age_meta = postVals.get(73).toString();
            this.rbca_hist_yr_built = Integer.parseInt(postVals.get(74).toString());;
            this.rbca_hist_age_src = Integer.parseInt(postVals.get(75).toString());
            ...
            this.rbca_dmg_total = Integer.parseInt(postVals.get(80).toString());
            ...
            this.rbca_struct = Integer.parseInt(postVals.get(85).toString());
            ...
            this.rbca_found = Integer.parseInt(postVals.get(89).toString());
            ...
            this.rbca_extwall = Integer.parseInt(postVals.get(93).toString());
            ...
            this.rbca_extfeat = Integer.parseInt(postVals.get(97).toString());
            ...
            this.rbca_win = Integer.parseInt(postVals.get(103).toString());
            ...
            this.rbca_roof = Integer.parseInt(postVals.get(109).toString());
            this.rbca_roof_notes = postVals.get(110).toString();
            this.rbca_int_cond = postVals.get(111).toString();
            this.rbca_int_collect_extant = Integer.parseInt(postVals.get(112).toString());
            ...
            this.rbca_int_img2 = postVals.get(117).toString();
            this.rbca_int_desc2 = postVals.get(118).toString();
            this.rbca_int_img3 = postVals.get(119).toString();
            this.rbca_int_desc3 = postVals.get(120).toString();
            this.rbca_int_notes = postVals.get(121).toString();
            this.rbca_landveg_feat = postVals.get(122).toString();
            this.rbca_landveg_feat_oth = postVals.get(123).toString();
            this.rbca_landveg = Integer.parseInt(postVals.get(124).toString());
            this.rbca_landveg_notes = postVals.get(125).toString();
            this.rbca_landblt_feat = postVals.get(126).toString();
            this.rbca_landblt_feat_oth = postVals.get(127).toString();
            this.rbca_landblt = Integer.parseInt(postVals.get(128).toString());
            this.rbca_landblt_notes = postVals.get(129).toString();
            this.rbca_media_img1 = postVals.get(130).toString();
            this.rbca_media_desc1 = postVals.get(131).toString();
            this.rbca_media_img2 = postVals.get(132).toString();
            this.rbca_media_desc2 = postVals.get(133).toString();
            this.rbca_media_img3 = postVals.get(134).toString();
            this.rbca_media_desc3 = postVals.get(135).toString();
            this.rbca_media_img4 = postVals.get(136).toString();
            this.rbca_media_desc4 = postVals.get(137).toString();
            this.rbca_media_img5 = postVals.get(138).toString();
            this.rbca_media_desc5 = postVals.get(139).toString();
            this.rbca_media_img6 = postVals.get(140).toString();
            this.rbca_media_desc6 = postVals.get(141).toString();
            this.rbca_hzrd = Integer.parseInt(postVals.get(142).toString());
            this.rbca_hzrd_type = postVals.get(143).toString();
            this.rbca_hzrd_type_oth = postVals.get(144).toString();
            this.rbca_hzrd_notes = postVals.get(145).toString();
            this.rbca_hzrd_hazmat = postVals.get(146).toString();
            this.rbca_hzrd_hazmat_oth = postVals.get(147).toString();
            this.rbca_actn = postVals.get(148).toString();
            this.rbca_actn_oth = postVals.get(149).toString();
            this.rbca_eval = postVals.get(150).toString();
            this.rbca_eval_oth = postVals.get(151).toString();

            //
            this.isLocalChange = (Integer) postVals.get(152) > 0;
