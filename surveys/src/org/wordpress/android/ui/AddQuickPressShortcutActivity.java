        ...
        dialogBuilder.setPositiveButton(R.string.add, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (TextUtils.isEmpty(quickPressShortcutName.getText())) {
                    ...
                    addIntent.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE, Intent.ShortcutIconResource.fromContext(AddQuickPressShortcutActivity.this, R.drawable.bw_nps));
    ...
    protected class HomeListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (wrapper.getBlavatar() != null) {
                try {
                    wrapper.getBlavatar().setImageResource(R.drawable.bw_nps);
